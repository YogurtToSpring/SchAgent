...
TOOL_LABELS = {
    ...
    "share_files": "将生成的文件共享给用户下载",
    "query_student_schedule": "课表查询",
    "query_course_info": "多条件查询课程信息",
    "query_class_students": "查询班级学生名单",
    "query_student_info": "查询学生个人信息",
    "query_room_info": "查询教室信息",
    "query_teacher_students": "查询教师所教课程及每门课的学生名单（按教师工号）",
    "query_free_room": "空闲教室查询",
    "query_course_students": "查询课程的学生名单（按课程号）",
    "query_all_teachers": "查询所有教师信息",
    "query_all_enrollments": "列出全部选课记录（管理员全景视图）",
    "query_student_grades": "查询学生个人成绩",
    "query_course_grades": "查询某门课程的全部学生成绩及统计信息（平均分",
